...
exports.createPengajuan = function (req, res) {
    ...
    let tolak= req.body.tolak

    connection.query('INSERT INTO pengajuan(pengajuan_id, cabang_id, marhunbih, angsuran, verifikasi, lunas, tgl_transaksi, tenor, nasabah_id, jenis_dp, dp_id, jenis_pekerjaan, pekerjaan_id,tolak) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
        [pengajuan_id, cabang_id, marhunbih, angsuran, verifikasi, lunas, tgl_transaksi, tenor, nasabah_id, jenis_dp, dp_id, jenis_pekerjaan, pekerjaan_id, tolak],
...
exports.lunasPengajuan = function (req, res) {
    
    let pengajuan_id = req.body.pengajuan_id;
    console.log(pengajuan_id)
    connection.query('UPDATE pengajuan SET lunas=true WHERE pengajuan_id = ?',
        [pengajuan_id],
        function (error, rows, fields) {
            console.log(error)
            if (error) {
...
exports.tolakPengajuan = function (req, res) {
    
    let pengajuan_id = req.body.pengajuan_id;
    console.log(pengajuan_id)
    connection.query('UPDATE pengajuan SET tolak=true WHERE pengajuan_id = ?',
        [pengajuan_id],
        function (error, rows, fields) {
            console.log(this.sql)
            if (error) {
...
exports.hapusPengajuan = function (req, res) {
    
    let pengajuan_id = req.body.pengajuan_id;
    
    connection.query('delete from pengajuan WHERE pengajuan_id = ?',
        [pengajuan_id],
        function (error, rows, fields) {
            if (error) {
                console.log(error)
